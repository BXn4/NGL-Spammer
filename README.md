...
If there is a new one, fork it!<br>You can run it here if you don't want to download it-> [Replit](https://replit.com/@BXn4/NGL-Spammeren#main.py) <br><br><a href="https://replit.com/@BXn4/NGL-Spammeren#main.py" target="_blank"><img src="https://img.shields.io/badge/replit-667881?style=for-the-badge&logo=replit&logoColor=white" alt="Replit"></a>
